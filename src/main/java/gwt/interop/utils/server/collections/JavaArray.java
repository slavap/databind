...
public class JavaArray<T> implements Array<T> {
    ...
    @Override
    public void push(@SuppressWarnings("unchecked") T... value) {
      if (value == null) return;
      for (T i : value) push(i);
    }
    ...
    @Override
    public Array<T> splice(int startIndx, int deleteCount, @SuppressWarnings("unchecked") T... toAdd) {
        JavaArray<T> out = new JavaArray<>();
