...
package org.jboss.errai9.common.client.ui;

import java.util.HashMap;
import java.util.Map;

//import org.jboss.errai9.common.client.dom.HTMLElement;
import org.jboss.errai9.common.client.ui.NativeHasValueAccessors.Accessor;
...
public abstract class ElementWrapperWidget<T> extends Widget {
  ...
  private static ElementWrapperWidget<?> createElementWrapperWidget(final Element element, final Class<?> valueType) {
    if (valueType != null) {
      ...
      if (NativeHasValueAccessors.hasValueAccessor(element)) {
        ...
        accessor = new DefaultAccessor((org.jboss.errai9.common.client.ui.HasValue) element);
      }
  ...
  private static class DefaultAccessor<T> implements Accessor<T> {
    ...
    private final org.jboss.errai9.common.client.ui.HasValue<T> instance;

    private DefaultAccessor(final org.jboss.errai9.common.client.ui.HasValue<T> instance) {
