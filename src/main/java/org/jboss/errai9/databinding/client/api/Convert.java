...
import org.jboss.errai9.common.client.api.WrappedPortable;
import org.jboss.errai9.common.client.ui.ElementWrapperWidget;
import org.jboss.errai9.databinding.client.AbstractOneWayConverter;
import org.jboss.errai9.databinding.client.ConverterRegistrationKey;
import org.jboss.errai9.databinding.client.OneWayConverter;
import org.jboss.errai9.databinding.client.TwoWayConverter;
...
public class Convert {
  ...
  private static class StringToObjectConverter extends AbstractOneWayConverter<String, Object> {
  ...
  private static final OneWayConverter<String, Object> STRING_TO_OBJECT = new StringToObjectConverter();
  ...
  private static <D, T> OneWayConverter<D, T> getOneWayConverter(final Class<D> domainType, final Class<T> targetType) {
    if (domainType.equals(targetType)) {
      ...
      else if (targetType.equals(Object.class)) { // in native databinding Object is default for field type, because real type is "unknown"
        return (OneWayConverter<D, T>) STRING_TO_OBJECT;
      }
      else {
        return null;
      }
